...
if __name__ == '__main__':
    print ('\nLoading the breast cancer wisconsin dataset courtesy of sklearn datasets.\nThis example applies the K- Nearest Neighbors algorithm to the breast cancer dataset for binary classification.')
